...
function sumarProductoRepetido (prodRepetido, productoId) {
  ...
  if (prodRepetido) {
    ...
    //En el modal cambia la cantidad de ese producto repetido por la actual 
...
//Esta funcion valida que el carrito tenga algo para agregar el btn de vaciar carrito
  ...
  //Sino agrego el boton de vaciar carrito
    ...
    let divComprar = document.getElementById('divComprar');
        divComprar.innerHTML = `<a href="./compra.html">
                                <button id="comprar-carrito" type="button" class="btn btn-danger blue">
                                <i class="small material-icons">check_circle </i> Comprar Carrito</button>
                                </a>`;    
  }
}
