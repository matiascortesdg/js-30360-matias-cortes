...
const getCard = (item) => {
return (`
<div class="card my-2 mx-2" style="width:20em;">
    <img src="${item.imagen}" class="card-img-top" alt="${item.nombre}">
    <div class="card-body">
        <h5 class="card-title">${item.nombre}</h5>
        <p class="card-text">Variedad: ${item.variedad}</p>
...
const agregarCarrito = (id) => {
    ...
    //Agregamos un Toastify cuando se agrega un producto
    Toastify({
...
//EVENTO de COMPRA USANDO SWEETALERT
...
btnComprar.addEventListener('click', () => {
    ...
    Swal.fire({
        title: 'Exito!',
        position: 'center',
        text: 'La compra se ha relizado satisfactoriamente',
        icon: 'success',
